            ...
            <div class="card">
              ...
              ?>      
                  <tr>
                    ...
                    <div style="display: inline-block;height: 40px; padding: 5px; border: 2px solid <?php echo $color_estpago; ?>; border-radius: 5px;">
                    <svg 
                          viewBox="0 0 512 512" 
                          fill="<?php echo $color_estpago; ?>" 
                          width="24" 
                          height="24">
                    ...
                    <div style="display: inline-block;width: 43px; height: 40px; padding: 5px; border: 2px solid <?php echo $color_estentrega; ?>; border-radius: 5px; margin-right: 18px;">
                      <svg 
                          onclick="<?php echo $boton_entre; ?>" 
                          viewBox="0 0 640 512" 
                          style="fill:<?php echo $color_estentrega; ?>;" 
                          width="30" 
                          height="30">
